...
def grpc_add_to_server():
    from control.generated.gateway_pb2_grpc import add_GatewayServicer_to_server
...
def grpc_stub(grpc_channel):
    from control.generated.gateway_pb2_grpc import GatewayStub
...
def test_bdev_rbd_create_pass(grpc_stub):
    ...
    # response = None
    # try:
    bdev_req = create_bdev_req(bdev_name="test_bdev", rbd_pool_name="rbd_pool", rbd_image_name='rbd_block',block_size=4096)
