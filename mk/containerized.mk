...
SVC ?= spdk ceph nvmeof nvmeof-cli ## Services
...
build: override OPTS += --no-rm $(foreach arg, $(ARGS), --build-arg $(arg)="$(strip $($(arg)))")
...
up: override OPTS += --abort-on-container-exit --exit-code-from nvmeof --remove-orphans --scale nvmeof=$(SCALE)
up: SVC = nvmeof
