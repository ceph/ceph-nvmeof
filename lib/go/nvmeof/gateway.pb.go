...
const file_gateway_proto_rawDesc = "" +
	...
	"\vconnections\x18\x04 \x03(\v2\v.connectionR\vconnections\"\x91\n" +
	"\n" +
	...
	"\x13_rbd_data_pool_nameB\v\n" +
	"\t_locationB\x17\n" +
	"\x15_rados_namespace_nameJ\x04\b\x19\x10\x1aR\x14encryption_algorithm\"\xa3\x01\n" +
...
var file_gateway_proto_depIdxs = []int32{
	...
	95, // 38: namespace_cli.encryption_entries:type_name -> encryption_entry
	86, // 39: namespaces_info.namespaces:type_name -> namespace_cli
	90, // 40: list_namespaces_io_stats_info.namespaces:type_name -> bdev_io_stats_info
	88, // 41: bdev_io_stats_info.io_error:type_name -> namespace_io_error
	88, // 42: namespace_io_stats_info.io_error:type_name -> namespace_io_error
	92, // 43: spdk_nvmf_log_flags_and_level_info.nvmf_log_flags:type_name -> spdk_log_flag_info
	...
	20, // 49: Gateway.create_subsystem:input_type -> create_subsystem_req
	21, // 50: Gateway.delete_subsystem:input_type -> delete_subsystem_req
	22, // 51: Gateway.change_subsystem_key:input_type -> change_subsystem_key_req
	23, // 52: Gateway.add_subsystem_network:input_type -> add_subsystem_network_req
	24, // 53: Gateway.del_subsystem_network:input_type -> del_subsystem_network_req
	27, // 54: Gateway.add_kmip_server_endpoints:input_type -> add_kmip_server_endpoints_req
	28, // 55: Gateway.del_kmip_server_endpoints:input_type -> del_kmip_server_endpoints_req
	29, // 56: Gateway.list_kmip_server_endpoints:input_type -> list_kmip_server_endpoints_req
	31, // 57: Gateway.list_namespaces:input_type -> list_namespaces_req
	...
	32, // 70: Gateway.add_host:input_type -> add_host_req
	35, // 71: Gateway.remove_host:input_type -> remove_host_req
	36, // 72: Gateway.set_keep_host_connected:input_type -> set_keep_host_connected_req
	33, // 73: Gateway.change_host_key:input_type -> change_host_key_req
	37, // 74: Gateway.list_hosts:input_type -> list_hosts_req
	38, // 75: Gateway.list_connections:input_type -> list_connections_req
	34, // 76: Gateway.get_connection_io_statistics:input_type -> get_connection_io_statistics_req
	39, // 77: Gateway.create_listener:input_type -> create_listener_req
	40, // 78: Gateway.delete_listener:input_type -> delete_listener_req
	41, // 79: Gateway.list_listeners:input_type -> list_listeners_req
	42, // 80: Gateway.list_subsystems:input_type -> list_subsystems_req
	43, // 81: Gateway.get_subsystems:input_type -> get_subsystems_req
	56, // 82: Gateway.set_ana_state:input_type -> ana_info
	44, // 83: Gateway.get_spdk_nvmf_log_flags_and_level:input_type -> get_spdk_nvmf_log_flags_and_level_req
	45, // 84: Gateway.disable_spdk_nvmf_logs:input_type -> disable_spdk_nvmf_logs_req
	46, // 85: Gateway.set_spdk_nvmf_logs:input_type -> set_spdk_nvmf_logs_req
	47, // 86: Gateway.get_gateway_info:input_type -> get_gateway_info_req
	48, // 87: Gateway.get_gateway_log_level:input_type -> get_gateway_log_level_req
	49, // 88: Gateway.set_gateway_log_level:input_type -> set_gateway_log_level_req
	50, // 89: Gateway.show_gateway_listeners_info:input_type -> show_gateway_listeners_info_req
	51, // 90: Gateway.get_gateway_stats:input_type -> get_gateway_stats_req
	52, // 91: Gateway.get_thread_stats:input_type -> get_thread_stats_req
	53, // 92: Gateway.set_gateway_io_stats_mode:input_type -> set_gateway_io_stats_mode_req
	59, // 93: Gateway.namespace_add:output_type -> nsid_status
	58, // 94: Gateway.create_subsystem:output_type -> subsys_status
	57, // 95: Gateway.delete_subsystem:output_type -> req_status
	57, // 96: Gateway.change_subsystem_key:output_type -> req_status
	57, // 97: Gateway.add_subsystem_network:output_type -> req_status
	57, // 98: Gateway.del_subsystem_network:output_type -> req_status
	57, // 99: Gateway.add_kmip_server_endpoints:output_type -> req_status
	57, // 100: Gateway.del_kmip_server_endpoints:output_type -> req_status
	30, // 101: Gateway.list_kmip_server_endpoints:output_type -> kmip_server_endpoints_info
	87, // 102: Gateway.list_namespaces:output_type -> namespaces_info
	57, // 103: Gateway.namespace_resize:output_type -> req_status
	91, // 104: Gateway.namespace_get_io_stats:output_type -> namespace_io_stats_info
	89, // 105: Gateway.list_namespaces_io_stats:output_type -> list_namespaces_io_stats_info
	57, // 106: Gateway.namespace_set_qos_limits:output_type -> req_status
	57, // 107: Gateway.namespace_change_load_balancing_group:output_type -> req_status
	57, // 108: Gateway.namespace_change_visibility:output_type -> req_status
	57, // 109: Gateway.namespace_change_location:output_type -> req_status
	57, // 110: Gateway.namespace_set_rbd_trash_image:output_type -> req_status
	57, // 111: Gateway.namespace_set_auto_resize:output_type -> req_status
	57, // 112: Gateway.namespace_delete:output_type -> req_status
	57, // 113: Gateway.namespace_add_host:output_type -> req_status
	57, // 114: Gateway.namespace_delete_host:output_type -> req_status
	57, // 115: Gateway.add_host:output_type -> req_status
	57, // 116: Gateway.remove_host:output_type -> req_status
	57, // 117: Gateway.set_keep_host_connected:output_type -> req_status
	57, // 118: Gateway.change_host_key:output_type -> req_status
	83, // 119: Gateway.list_hosts:output_type -> hosts_info
	85, // 120: Gateway.list_connections:output_type -> connections_info
	82, // 121: Gateway.get_connection_io_statistics:output_type -> connection_io_statistics
	57, // 122: Gateway.create_listener:output_type -> req_status
	57, // 123: Gateway.delete_listener:output_type -> req_status
	75, // 124: Gateway.list_listeners:output_type -> listeners_info
	64, // 125: Gateway.list_subsystems:output_type -> subsystems_info_cli
	60, // 126: Gateway.get_subsystems:output_type -> subsystems_info
	57, // 127: Gateway.set_ana_state:output_type -> req_status
	93, // 128: Gateway.get_spdk_nvmf_log_flags_and_level:output_type -> spdk_nvmf_log_flags_and_level_info
	57, // 129: Gateway.disable_spdk_nvmf_logs:output_type -> req_status
	57, // 130: Gateway.set_spdk_nvmf_logs:output_type -> req_status
	66, // 131: Gateway.get_gateway_info:output_type -> gateway_info
	94, // 132: Gateway.get_gateway_log_level:output_type -> gateway_log_level_info
	57, // 133: Gateway.set_gateway_log_level:output_type -> req_status
	77, // 134: Gateway.show_gateway_listeners_info:output_type -> gateway_listeners_info
	71, // 135: Gateway.get_gateway_stats:output_type -> gateway_stats_info
	72, // 136: Gateway.get_thread_stats:output_type -> thread_stats_info
	57, // 137: Gateway.set_gateway_io_stats_mode:output_type -> req_status
