...
func (c *gatewayClient) GwRefreshNetwork(ctx context.Context, in *GwRefreshNetworkReq, opts ...grpc.CallOption) (*GwRefreshNetworkStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedGatewayServer) DelKmipServerEndpoints(context.Context, *DelKmipServerEndpointsReq) (*ReqStatus, error) {
	return nil, status.Error(codes.Unimplemented, "method DelKmipServerEndpoints not implemented")
}
func (UnimplementedGatewayServer) ListKmipServerEndpoints(context.Context, *ListKmipServerEndpointsReq) (*KmipServerEndpointsInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method ListKmipServerEndpoints not implemented")
}
...
func (UnimplementedGatewayServer) GetThreadStats(context.Context, *GetThreadStatsReq) (*ThreadStatsInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method GetThreadStats not implemented")
}
func (UnimplementedGatewayServer) SetGatewayIoStatsMode(context.Context, *SetGatewayIoStatsModeReq) (*ReqStatus, error) {
	return nil, status.Error(codes.Unimplemented, "method SetGatewayIoStatsMode not implemented")
}
...
func _Gateway_GwRefreshNetwork_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GwRefreshNetworkReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServer).GwRefreshNetwork(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GwRefreshNetwork_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
